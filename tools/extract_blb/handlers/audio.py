...
# NOTE: Asset 700 is NOT audio (it was mis-handled as an SPU sample bank here,
# which produced ~1KB of garbage WAV). It is demo/attract-mode input replay data
# -- see handlers/demo.py and docs/systems/demo-attract-mode.md.
