  ...
  segments: [
...

    {
      ...
      subsegments: [
        ...
        dotdata('8BCCC', 'movie'),     // 0x8009B4CC (16B: movie halfword table grouped, D_8009B4CE..D_8009B4DA aliased) -> build/src/movie.o(.data)
        data('8BCDC', 'data'),         // 0x8009B4DC gap (asm)
        dotdata('8BD5C', 'enemies'),   // 0x8009B55C (216B: enemy behavior dispatch tables, D_8009B57C..D_8009B5EC aliased) -> build/src/enemies.o(.data)
        data('8BE34', 'data'),         // 0x8009B634 gap up to bosses island (asm)
        ...
        data('8C974', 'data'),         // 0x8009C174 gap (asm)
        dotdata('8CA54', 'playst'),    // 0x8009C254 (28B: playst table grouped) -> build/src/playst.o(.data)
        data('8CA70', 'data'),         // 0x8009C270 gap (asm)
        dotdata('8CBA8', 'player'),    // 0x8009C3A8 (28B: player table grouped) -> build/src/player.o(.data)
        data('8CBC4', 'data'),         // 0x8009C3C4 gap up to finn island (asm)
        ...
        data('8D3AC', 'data'),         // 0x8009CBAC gap (passwd/unref, asm)
        dotdata('8D3BC', 'ending'),    // 0x8009CBBC (32B: ending table grouped) -> build/src/ending.o(.data)
        data('8D3DC', 'data'),         // 0x8009CBDC gap (menu/passwd shared, asm)
        dotdata('8D3E8', 'menu'),      // 0x8009CBE8 (16B: menu table grouped) -> build/src/menu.o(.data)
        data('8D3F8', 'data'),         // 0x8009CBF8 gap up to sound island (asm)
        ...
        data('8DA28', 'data'),         // 0x8009D228 gap (post-sound/gstate, asm)
        dotdata('8E1C0', 'lvlload'),   // 0x8009D9C0 (60B: lvlload tables grouped, D_8009D9C1/D_8009D9C2 aliased) -> build/src/lvlload.o(.data)
