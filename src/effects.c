...
u8 D_8009B3A0[20] asm("D_8009B3A0") = {
    0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0xFF, 0xFF,
    0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00,
    0x00, 0x40, 0xFF, 0xFF,
};
u8 D_8009B3B4[20] asm("D_8009B3B4") = {
    0x10, 0x06, 0xCE, 0x09, 0x10, 0x06, 0xCE, 0x0A,
    0x10, 0x06, 0xCE, 0x0C, 0x10, 0x06, 0xCE, 0x00,
    0x10, 0x06, 0xCE, 0x18,
};
u8 D_8009B3C8[16] asm("D_8009B3C8") = {
    0x00, 0x04, 0x0A, 0x0E, 0x10, 0x0C, 0x06, 0x02,
    0x00, 0x04, 0x0A, 0x0E, 0x10, 0x0C, 0x06, 0x02,
};
