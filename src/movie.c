...
/* .data island 0x8009B4CC..0x8009B4DC (16B, movie halfword scratch table) migrated from asm. */
/* Zero-initialized halfword slots; accessed at +2 granularity by the movie asm
 * (D_8009B4CE/D2/D6/DA referenced). Aliases preserve the individual addresses. */
s16 D_8009B4CC[8] asm("D_8009B4CC") = {0, 0, 0, 0, 0, 0, 0, 0};
