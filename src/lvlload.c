...
/* .data island 0x8009D9C0..0x8009D9FC (60B, lvlload tables) migrated from asm; grouped u8[] + .set aliases. */
/* group island: 0-byte pad at 0x8009D9C0, 3 aliased symbol(s); anchor D_8009D9C0 (60B). */
u8 D_8009D9C0[60] asm("D_8009D9C0") = {
    0x00, 0x00, 0x00, 0x20, 0x20, 0x20, 0x30, 0x30,
    0x30, 0x40, 0x40, 0x40, 0x70, 0x70, 0x70, 0xA0,
    0xA0, 0xA0, 0xFF, 0xFF, 0xFF, 0x60, 0x20, 0x20,
    0x40, 0x20, 0x20, 0x20, 0x60, 0x20, 0x20, 0x40,
    0x20, 0x20, 0x20, 0x60, 0x20, 0x20, 0x40, 0x08,
    0x60, 0x60, 0x10, 0x40, 0x40, 0x60, 0x08, 0x60,
    0x40, 0x10, 0x40, 0x60, 0x60, 0x08, 0x40, 0x40,
    0x10, 0x40, 0x10, 0x60,
};
asm(".globl D_8009D9C1\n.set D_8009D9C1, D_8009D9C0 + 1\n.globl D_8009D9C2\n.set D_8009D9C2, D_8009D9C0 + 2\n");
