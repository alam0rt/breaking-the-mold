...
/* .data island 0x8009CBBC..0x8009CBDC (32B, ending table) migrated from asm; grouped u8[]. */
/* group island: 0-byte pad at 0x8009CBBC, 1 aliased symbol(s); anchor D_8009CBBC (32B). */
u8 D_8009CBBC[32] asm("D_8009CBBC") = {
