...
/* FINNCallback_DispatchToEntityHandler @ 0x8006EC60 — dispatch to a per-state
 * handler selected by e[0x106]: 0 = no-op; >0 indexes the state table at
...
/* .data island 0x8009CA34..0x8009CADC (168B, finn rotation sprite tables) migrated from asm. */
/* Three packed 32-bit sub-tables: rotation sprite ids at +0 and +72
 * (FINN_ROTATION_SPRITE_TABLE), plus a param table at +136. */
u32 D_8009CA34[42] asm("D_8009CA34") = {
    0x10B95A10, 0x10B95C10, 0x10B95010, 0x10B94810,
    0x10B97810, 0x10B91810, 0x10B9D810, 0x10B85810,
    0x10BB5810, 0x10B95A1C, 0x10B95C1C, 0x10B9501C,
    0x10B9481C, 0x10B9781C, 0x10B9181C, 0x10B9D81C,
    0x088C5011, 0x00000000, 0x10B95A10, 0x10B95C10,
    0x10B95010, 0x10B94810, 0x10B97810, 0x10B91810,
    0x10B9D810, 0x10B85810, 0x10BB5810, 0x10B95A1C,
    0x10B95C1C, 0x10B9501C, 0x10B9481C, 0x10B9781C,
    0x10B9181C, 0x10B9D81C, 0x3C389550, 0x1E181D10,
    0x1A202D81, 0x08208902, 0x3EB98520, 0x5238CD10,
    0x04835000, 0x00000000,
};
